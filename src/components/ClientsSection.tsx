...
const clients = Array.from({ length: 10 }, (_, i) => ({
  ...
  return (
    <section className="tp-brand-6-area relative pt-[60px] pb-[60px] lg:pt-[100px] lg:pb-[100px] bg-transparent overflow-hidden">
      <div className="container">
        ...
        <div className="relative overflow-hidden">
          <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-transparent to-transparent z-10" />
          <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-transparent to-transparent z-10" />
          <div className="flex gap-4 animate-[marquee_30s_linear_infinite] hover:[animation-play-state:paused] w-max">
            {[...clients, ...clients, ...clients].map((c, idx) => (
              <div key={`${c.id}-${idx}`} className="flex h-[90px] w-[160px] shrink-0 items-center justify-center p-4">
